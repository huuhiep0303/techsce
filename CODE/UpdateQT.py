...
image_directory = r"D:\KHKT_12_FINAL\KHKT_12_FINAL\DATA"

class CameraApp(QtWidgets.QMainWindow):
    def __init__(self):
        super(CameraApp, self).__init__()
        uic.loadUi(r'D:\KHKT_12_FINAL\KHKT_12_FINAL\FILE_UI\Diemdanh_UI.ui', self)  
        ...
        if self.selected_date:
            ...
            try:
                ...
                if column_letter is None:
                    ...
                    # QtWidgets.QMessageBox.information(self, "Thành công", f"Thêm cột mới cho ngày: {self.selected_date}")
                else:
                    # QtWidgets.QMessageBox.warning(self, "Cảnh báo", f"Cột cho ngày {self.selected_date} đã tồn tại ở vị trí: {column_letter}")
                    None
